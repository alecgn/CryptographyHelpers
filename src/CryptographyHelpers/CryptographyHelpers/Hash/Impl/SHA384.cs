...
{
    public class SHA384 : HashBase, IHash
    {
        private const HashAlgorithmType _hashAlgorithmType = HashAlgorithmType.SHA384;
        ...
        /// </summary>
        /// <param name="hashHexadecimalString">The pre-computed SHA384 hash hexadecimal encoded string.</param>
