...
{
    public class SHA1 : HashBase, IHash
    {
        private const HashAlgorithmType _hashAlgorithmType = HashAlgorithmType.SHA1;
        ...
        /// </summary>
        /// <param name="hashHexadecimalString">The pre-computed SHA1 hash hexadecimal encoded string.</param>
