namespace CryptographyHelpers.Hash
{
    ...
    {
        private const HashAlgorithmType _hashAlgorithmType = HashAlgorithmType.SHA256;
        ...
        /// </summary>
        /// <param name="hashHexadecimalString">The pre-computed SHA256 hash hexadecimal encoded string.</param>
